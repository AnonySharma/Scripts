(function() {
  console.clear();
  console.log('%c[AnonySub] Initializing Console Injection Engine...', 'color: #38bdf8; font-weight: bold; font-size: 14px;');
  ...
  if (!video) return console.error('[AnonySub] Aborted: No HTML5 video element located on this page.');
  ...
  console.log('%c[AnonySub] Secure Injection Box Running.', 'color: #22c55e; font-weight: bold;');
})();
